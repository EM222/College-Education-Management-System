							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Birth cert S/No:</label>
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">ID No/Birth Cert No:</label>
												    <input type="text" name="cnic" data-inputmask="'mask': '99999-9999999-9'" placeholder="XXXXXXXXXXXXX" class="form-control">
											    </div>
											</div>
								  		</div>
								  		<div class="row">
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Secondary School start Date: </label>
											        <input type="date" name="matric_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Secondary School Completion Date:</label>
												    <input type="date" name="matric_awarded_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload KCSE/OLevel Certificate:</label>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Primary School start Date: </label>
											        <input type="date" name="fa_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Primary School Completion Date:</label>
												    <input type="date" name="fa_awarded_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload KCPE/ALevel Certificate:</label>
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Birth Certificate Application Date:</label>
